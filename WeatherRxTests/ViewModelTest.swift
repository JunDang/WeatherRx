...
class ViewModelTests: XCTestCase {
    ...
    private func createViewModel(_ lat:Double, _ lon: Double, _ currentWeather: String) -> ViewModel {
        return ViewModel(lat: lat, lon: lon, apiType: MockFlickrService.self, imageDataCacheType: ImageDataCaching.self)
    }
